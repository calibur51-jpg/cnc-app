...
# --- [區塊 1：安全庫存監控表 (以總庫存為基準)] ---
        ...
        if not low_stock_df.empty:
            ...
            # 顯示表格，新增一欄「總庫存」讓你看得更清楚
            st.dataframe(low_stock_df[["分類", "品名規格", "架上", "倉庫數量", "總庫存", "安全庫存"]], use_container_width=True, hide_index=True)
            ...
            st.success("✅ 目前所有刀具總庫存皆高於安全庫存，無需叫貨。")
